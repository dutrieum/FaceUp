...
<div class="wrap_presentation">
    <div class="parent_presentation">
      <div class="child_photop"><img src="<?php echo(get_field('doctor_presentation')['url']); ?>"/></div>
    ...
    <div class="parent_presentation">
      <div class="child_photop2"><img src="<?php echo(get_field('massage_presentation')['url']); ?>"/></div>
    ...
    <div class="parent_presentation">
      <div class="child_photop"><img src="<?php echo(get_field('face_presentation')['url']); ?>"/></div>
